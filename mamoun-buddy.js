...
const launcher=el('button','mamoun-buddy-launcher','<span class="mb-badge">🎙️</span><span class="mb-label">تحدّث مع المأمون</span><img src="assets/mamoun-buddy.png?v=367" alt="المأمون">');
...
backdrop.innerHTML=`<section class="mamoun-buddy-panel" role="dialog" aria-modal="true" aria-label="التحدث مع المأمون">
 <div class="mb-scene">
   <div class="mb-avatar-wrap"><div class="mb-avatar" id="mbAvatar"><img src="assets/mamoun-buddy.png?v=367" alt="شخصية المأمون"><span class="mb-mouth"></span></div><span class="mb-listen-ring"></span></div>
 ...
 <div class="mb-console">
   ...
   <footer class="mb-controls"><button class="mb-main-action" id="mbStart">🎙️ <span>ابدأ الحديث</span></button><div class="mb-control-row"><button class="mb-mini" id="mbMute" disabled>🔇 كتم الميكروفون</button><button class="mb-mini" id="mbContext" disabled>✨ ساعدني في هذه المهمة</button></div><div class="mb-privacy">لا يحتاج المأمون إلى اسمك أو أي معلومات شخصية. تحدّث فقط عن نشاط التعلّم.</div></footer>
 </div>
